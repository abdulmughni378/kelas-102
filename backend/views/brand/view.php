...
$this->title = 'View Brand: '.$model->brand_id;
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-lg-12 col-xs-12 col-md-12">
                        <p>
                            <?= Html::a('<button type="button" class="btn btn-sm btn-info"> <i class="fa fa-fw fa-chevron-left"></i> Back</button>', ['/brand']) ?>
                            <?= Html::a('Update', ['update', 'id' => $model->brand_id], ['class' => 'btn btn-sm btn-primary']) ?>
